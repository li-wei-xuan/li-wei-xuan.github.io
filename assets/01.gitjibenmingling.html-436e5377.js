import{_ as t,p as a,q as d,w as e,s as i,Y as n}from"./framework-aa5c4115.js";const l={},s=i("p",null,[i("img",{src:"https://img.webvipzone.com/images/git.png",alt:"git"})],-1),r=n(`<h2 id="创建仓库命令" tabindex="-1"><a class="header-anchor" href="#创建仓库命令" aria-hidden="true">#</a> 创建仓库命令</h2><h3 id="git-init" tabindex="-1"><a class="header-anchor" href="#git-init" aria-hidden="true">#</a> git init</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>//初始化仓库
git init
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,34);function c(g,v){return a(),d("div",null,[e(" https://www.runoob.com/git/git-basic-operations.html "),s,e(" ![git](/images/git.png) "),r])}const m=t(l,[["render",c],["__file","01.gitjibenmingling.html.vue"]]);export{m as default};
