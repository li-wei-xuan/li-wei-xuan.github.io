import{_ as n,o as s,c as a,a as e}from"./app-COkxg5ot.js";const i={},t=e(`<h3 id="虚拟-dom-实现原理" tabindex="-1"><a class="header-anchor" href="#虚拟-dom-实现原理"><span>虚拟 DOM 实现原理？</span></a></h3><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code>虚拟 <span class="token constant">DOM</span> 的实现原理主要包括以下 <span class="token number">3</span> 部分：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="proxy-与-object-defineproperty-优劣对比" tabindex="-1"><a class="header-anchor" href="#proxy-与-object-defineproperty-优劣对比"><span>Proxy 与 Object.defineProperty 优劣对比</span></a></h3><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code>Proxy 的优势如下<span class="token operator">:</span>
	可以直接监听对象而非属性；
	可以直接监听数组的变化；
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue-框架怎么实现对象和数组的监听" tabindex="-1"><a class="header-anchor" href="#vue-框架怎么实现对象和数组的监听"><span>Vue 框架怎么实现对象和数组的监听？</span></a></h3><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code>如果被问到 Vue 怎么实现数据双向绑定，大家肯定都会回答 通过 Object<span class="token punctuation">.</span><span class="token function">defineProperty</span><span class="token punctuation">(</span><span class="token punctuation">)</span> 对数据进行劫持，
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue-是如何实现数据双向绑定的" tabindex="-1"><a class="header-anchor" href="#vue-是如何实现数据双向绑定的"><span>Vue 是如何实现数据双向绑定的？</span></a></h3><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code>Vue 数据双向绑定主要是指：数据变化更新视图，视图变化更新数据
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="你有对-vue-项目进行哪些优化" tabindex="-1"><a class="header-anchor" href="#你有对-vue-项目进行哪些优化"><span>你有对 Vue 项目进行哪些优化？</span></a></h3><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code>（<span class="token number">1</span>）代码层面的优化
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue3-0-特性你有什么了解的吗" tabindex="-1"><a class="header-anchor" href="#vue3-0-特性你有什么了解的吗"><span>vue3.0 特性你有什么了解的吗？</span></a></h3><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code>Vue <span class="token number">3.0</span> 的目标是让 Vue 核心变得更小、更快、更强大，因此 Vue <span class="token number">3.0</span> 增加以下这些新特性：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),l=[t];function p(c,r){return s(),a("div",null,l)}const d=n(i,[["render",p],["__file","mianshiti2.html.vue"]]),u=JSON.parse('{"path":"/docs/interview/mianshiti2.html","title":"vue面试题","lang":"zh-CN","frontmatter":{"title":"vue面试题","date":"2023-03-16T00:00:00.000Z","tags":["interview"],"categories":["interview"]},"headers":[{"level":3,"title":"虚拟 DOM 实现原理？","slug":"虚拟-dom-实现原理","link":"#虚拟-dom-实现原理","children":[]},{"level":3,"title":"Proxy 与 Object.defineProperty 优劣对比","slug":"proxy-与-object-defineproperty-优劣对比","link":"#proxy-与-object-defineproperty-优劣对比","children":[]},{"level":3,"title":"Vue 框架怎么实现对象和数组的监听？","slug":"vue-框架怎么实现对象和数组的监听","link":"#vue-框架怎么实现对象和数组的监听","children":[]},{"level":3,"title":"Vue 是如何实现数据双向绑定的？","slug":"vue-是如何实现数据双向绑定的","link":"#vue-是如何实现数据双向绑定的","children":[]},{"level":3,"title":"你有对 Vue 项目进行哪些优化？","slug":"你有对-vue-项目进行哪些优化","link":"#你有对-vue-项目进行哪些优化","children":[]},{"level":3,"title":"vue3.0 特性你有什么了解的吗？","slug":"vue3-0-特性你有什么了解的吗","link":"#vue3-0-特性你有什么了解的吗","children":[]}],"git":{"createdTime":1679887873000,"updatedTime":1679887873000,"contributors":[{"name":"liweijiang","email":"916215061@qq.com","commits":1}]},"filePathRelative":"docs/interview/面试题2.md","readingTime":{"minutes":6.9,"words":2069}}');export{d as comp,u as data};
