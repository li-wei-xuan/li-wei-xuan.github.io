import{_ as e,p,q as o,s as n,R as a,t,Y as l,n as c}from"./framework-aa5c4115.js";const i={},r=l(`<h2 id="vue2响应式原理" tabindex="-1"><a class="header-anchor" href="#vue2响应式原理" aria-hidden="true">#</a> Vue2响应式原理</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>通过原生JavaScript中的Object.defineproperty方法来对数据进行劫持。  
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue3响应式原理" tabindex="-1"><a class="header-anchor" href="#vue3响应式原理" aria-hidden="true">#</a> Vue3响应式原理</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token literal-property property">实现原理</span><span class="token operator">:</span> 
